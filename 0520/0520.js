...
const nameList1 = nameList.filter(x => x != '장은서');
...
const result = list3.filter(x => x.like >= 100);
...
const result2 = list4.reduce((a, b) => a + b.like, 0); 
...
const result3 = list5.some(a => a.like >= 100/* like가 100 이상인 것이 있는지 확인하는 콜백을 작성하세요 */);
...
const result4 = list6.every(a => a.like >= 100/* like가 100 이상인 것만 있는지 확인하는 콜백을 작성하세요 */);
