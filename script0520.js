...
result1 = nameList.filter((item) => item != '장은서')
...
reultList = list1.sort((a,b) => b.like -a.like)
console.log(reultList);
...
const map1 = list2.map((x) => (x.title + x.content));
console.log(map1);
...
const result2 = list4.reduce((sum, b) => sum + b.like, 0); 
...
const result3 = list5.some((x) => x.like > 100);
...
const result4 = list6.every((x) => x.like > 100);
