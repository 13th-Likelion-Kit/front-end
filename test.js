...
const index = nameList.indexOf("장은서");
if (index !== -1) {
  nameList.splice(index, 1); // 해당 인덱스에서 1개 요소 제거
}
...
list2.map(/* 제목과 내용을 출력하는 map 콜백을 작성하세요 */);
...
const result = list3.filter(/* like가 100 이상인 것만 필터링하는 콜백을 작성하세요 */);
...
const result2 = list4.reduce(/* like의 총합을 구하는 콜백을 작성하세요 */); 
...
const result3 = list5.some(/* like가 100 이상인 것이 있는지 확인하는 콜백을 작성하세요 */);
...
const result4 = list6.every(/* like가 100 이상인 것만 있는지 확인하는 콜백을 작성하세요 */);
